/*
  ...
  - The values [CAROUSEL] on the enum `MEDIATYPE` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
ALTER TYPE "LISTENERS" ADD VALUE 'SMARTAI';
